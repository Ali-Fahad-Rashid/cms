...
<div class="col-md-4 xs-3 sm-3">
        ...
        $query = "INSERT INTO admin_category(cat_post_id, cat_title, cat_user, cat_status,
        cat_date, cat_image, cat_content, cat_user_id) ";
        $query .= "VALUES(?, ?,?,?
        ,now(),?,?,?) ";      
...
<select class=custom-select name="cat_post_id" id=""><?php
